...
contract XanV1VotingTest is Test, MockPersons {
    ...
    function testFuzz_lockedBalanceOf_is_bound_by_balanceOf(address owner) public view {
        assertLe(_xanProxy.lockedBalanceOf(owner), _xanProxy.balanceOf(owner));
    }

    function testFuzz_unlockedBalanceOf_is_bound_by_balanceOf(address owner) public view {
